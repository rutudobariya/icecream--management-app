...
export default function AdminHeader() {
  return (
    ...
    <div className="row">
      <div className="admin-logo col-md-2 bg-dark p-3">
      ...
      <div className="admin-notification col-md-4 p-2 mt-0">
          ...
          <ul className="header-link">
            <li className="dropdown">
              ...
              <ul className="dropdown-menu">
                ...
                <li>
                  <a href="/admin-login/change-password">
                ...
                <li>
                  <a href="/admin-login/admin-logout">
