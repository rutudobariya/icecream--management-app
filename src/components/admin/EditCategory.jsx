...
useEffect(()=>{
// axios.get()
axios.get(`http://localhost:4000/addcategory/${id}`).then((response)=>{
...
axios.put(`http://localhost:4000/addcategory/${id}`,updcat).then(()=>{
...
<h2 className="ms-3 p-4 mt-3 text-success">Edit Category</h2>
