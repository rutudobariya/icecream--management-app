...
<h2 className="ms-3 p-4 mt-3">Manage Category all data</h2>
...
<td><button type='button' onClick={()=>Navigate(`/admin-login/delete-category/${row.id}`)} className='btn btn-danger text-white btn-sm'><i className='bi bi-trash'></i></button>

<button type='button' onClick={()=>Navigate(`/admin-login/edit-category/${row.id}`)} className='btn btn-info text-white btn-sm ms-2'><i className='bi bi-pencil '></i></button>
